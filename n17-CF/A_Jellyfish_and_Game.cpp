...
//         ll n, m, k;
//         cin >> n >> m >> k;
//         vector<int> jelly(n); // Jellyfish's green apples
//         for (int i = 0; i < n; i++)
//         {
//             cin >> jelly[i];
//         }

//         vector<int> gelly(m); // Gellyfish's green apples
//         for (int i = 0; i < m; i++)
//         {
//             cin >> gelly[i];
//         }

//         // Sort both vectors to easily find the minimum and maximum
//         sort(jelly.begin(), jelly.end());
//         sort(gelly.begin(), gelly.end()); // Sort in descending order for Gellyfish

//         if (k == 1)
//         {
//             swap(jelly[0], gelly[m - 1]);
//             ll sum = accumulate(jelly.begin(), jelly.end(), 0);
//             cout << sum << endl;
//             return 0;
//         }
//         int chance = 0;
...
//             // Calculate the final sum of Jellyfish's apples
//             ll sum = accumulate(jelly.begin(), jelly.end(), 0LL);
//             cout << sum << endl;
//         }
//     }
...
int solve()
{
    ...
    sort(all(g));
    vector<ll> v1;
    multiset<ll> jj(all(j));
    multiset<ll> gg(all(g));
    for (int i = 0; i < 50; i++)
    {
        ll summ = 0;
        ll x = 0, y = 0;
